...
# gives the music player an interface
music_player = tkr.Tk()
music_player.title("AMB Music")
music_player.geometry("500x400")

# create the directory
directory = askdirectory()
os.chdir(directory)  # permits change to the current directory.
song_list = os.listdir()  # it returns the list of files
